...
from app.api.deps import get_menu_repo, get_recipe_repo, get_staple_repo
...
async def _breakdown(
    menu_repo: MenuRepo, recipe_repo: RecipeRepo, staple_repo: StapleRepo
) -> ShoppingListOut:
...
async def get_shopping_list(
    ...
    return await _breakdown(menu_repo, recipe_repo, staple_repo)
